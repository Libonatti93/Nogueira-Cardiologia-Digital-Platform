...
| NEXT_PUBLIC_SITE_URL | Origem canônica, links e validação de Origin |
...
identidade. Não substituir o subject de Matheus nem criar login duplicado.
...
validação. Login local de Dr. Paulo e autorização por sessões válidas independem
